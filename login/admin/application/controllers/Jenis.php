...
class Jenis extends CI_Controller {
	...
	public function index()
	{
		...
		$data['data'] = $this->db->get('jenis_produk')->result_array();
		...
		if($this->form_validation->run() == false)
		{
			...
			$this->Jenis_model->tambahData();
		}
	}

	public function hapusData($id)
	{
		if (!$this->Jenis_model->hapusJenis($id)) {
			//jika data berhasil
	...
	public function ubahData()
	{
		...
		echo json_encode($this->db->get_where('jenis_produk', ['id_jenis' => $_POST['id']])->row_array());
	}
	...
	public function ubah()
	{
		...
		if($this->form_validation->run() == false)
		{
			...
			$this->Jenis_model->ubahJenis($_POST['id']);
		}
