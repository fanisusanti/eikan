                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav ml-auto">
                            <a href="index.html" class="nav-item nav-link active">Tentang CBD Discus</a>
                            <a href="product-list.html" class="nav-item nav-link">Artikel</a>
                            <a href="product-detail.html" class="nav-item nav-link">Publikasi</a>
                            <a href="cart.html" class="nav-item nav-link">Forum Diskusi</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="bottom-bar">
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <table>
                            <td><a href="#" class="btn cart" data-toggle="dropdown">Buka Kios</a></td>
                            <td><div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="#" class="dropdown-item btn wishlist">Edit Profile</a>
